        					...
        					<table class="table table-striped table-advance table-hover">
        						...
        						<tbody>
        							...
        							while ($row = $consultar_banners->fetch()) {
        								echo '<tr>
        								<td>
                                       <a href="basic_table.html#">'.$row['banner_id'].'</a>
                                       </td>
                                       <td class="hidden-phone">'.$row['banner_nombre'].'</td>
                                       <td><img class="img-responsive" src="'.$row['banner_imagen'].'"></td>

                                       <td>
                                       
                                       <button class="btn btn-primary btn-xs btn-editar" id="'.$row['banner_id'].'">Editar</button>
                                       <button class="btn btn-danger btn-xs btn-eliminar" id="'.$row['banner_id'].'">Eliminar</button>
                                       </td>
                                       </tr>';	
                                   }
                                   ?>
   ...
   <script>
    $(document).ready(function(){
        ...
        $(".btn-editar").click(function(){
         ...
         window.location.href = "../controlador_banner/cargar_vista_editar_banner?banner_id="+banner+"";
     });
        ...
        $(".btn-eliminar").click(function(){
         ...
         alertify.confirm("Deseas eliminar este archivo.",
            function(){
             window.location.href = "../controlador_banner/eliminar_banner?banner_id="+banner+"";
