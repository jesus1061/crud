...
<!--sidebar end-->
  ...
  <script type="text/javascript">
    $(document).ready(function() {
     ...
     $(".wrapper").load("crear_elemento_fuente");

     /*Navegacion*/

     /*Despliega el formulario de registro de un funcionario*/
     $("#crear_funcionario").click(function(){
      $(".wrapper").load("crear_funcionario");

    });

     /*Despliega los archivos subidos al servidor tanto imagenes como videos*/

     $("#ver_archivos").click(function(){
      $(".wrapper").load("ver_archivos");

    });

     /*Despliega el formulario para la creacion de un elemento fuente multimedia*/
