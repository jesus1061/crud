          ...
          <section class="wrapper">
            <div class="row mt">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="message"></div>
                <form class="contact-form php-mail-form" role="form" action="../controlador_banner/crear_banner" method="POST">

                  <div class="form-group">
                    <input type="name" name="banner_nombre" class="form-control" id="contact-name" placeholder="Nombre Del banner" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                  </div>

                  <div class="form-group">
                    <input type="text" name="banner_imagen" class="form-control" id="abrir_archivos" placeholder="Escoga aqui el banner" readonly style="cursor: pointer" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                    <div class="validate"></div>
                  </div>
                ...
                <div class="form-send">
                  <button type="submit" class="btn btn-large btn-primary">Crear Banner</button>
                </div>
