  <?php
  $banner_id = $_SESSION['banner_editar'];
  include_once "application/controllers/admin/archivos/listar_archivos.php";
  include_once "application/controllers/admin/banners/editar_banner.php";
          ...
          <section class="wrapper">
            <div class="row mt">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="message"></div>
                <form class="contact-form php-mail-form" role="form" action="../controlador_banner/editar_banner" method="POST">
                  <?php
                  while ($row = $consultar_banner->fetch()) {
                    echo '
                    <div class="form-group" style="display:none">
                    <input type="name" name="banner_id" class="form-control" value="'.$row['banner_id'].'"  placeholder="Nombre Del banner" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required readonly >
                    <div class="validate"></div>
                    </div>
                    <div class="form-group">
                    <input type="name" name="banner_nombre" class="form-control" value="'.$row['banner_nombre'].'"  placeholder="Nombre Del banner" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required >
                    <div class="validate"></div>
                    </div>
                    <div class="form-group">
                    <input type="text" name="banner_imagen" class="form-control" value="'.$row['banner_imagen'].'" id="abrir_archivos" placeholder="Escoga aqui el banner" readonly style="cursor: pointer" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required>
                    <div class="validate"></div>
                    </div>
                    ';
                  }
                ...
                <div class="form-send">
                  <button type="submit" class="btn btn-large btn-primary">Editar Banner</button>
                </div>
